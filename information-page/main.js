...
mountainSelect.addEventListener('change', function() {
    ...
    document.getElementById('mountainElevation').textContent = selectedMountain.elevation
    document.getElementById('mountainEffort').textContent = selectedMountain.effort
    document.getElementById('mountainCoords').textContent = selectedMountain.coords
});
